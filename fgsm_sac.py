...
EXPERIMENT_NAME = "FGSM_SAC_humanoid-V5"
N_EPISODES = 30                        # 建议设为30以匹配统计意义
EPSILON_LIST = [0.0, 0.005, 0.01, 0.015, 0.02, 0.025, 0.03, 0.05]  # 确保第一个必须是 0.0，用于自动获取基准分

VIDEO_FOLDER = "./attack_videos_sac_fgsm"
# ====================================================
...
def run_experiment():
    ...
    print(f"📡 启动 FGSM 扫描 | 模型: {os.path.basename(MODEL_PATH)}")
    ...
    print("="*80)
    print(f"✅ 实验完成！总耗时: {total_duration/60:.2f} 分钟")
