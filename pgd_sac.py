...
MODEL_PATH = "./model/humanoid-v5-SAC.zip" # 确认路径

EXPERIMENT_NAME = "PGD_SAC_humanoid-V5_N30" # 结果文件前缀
N_EPISODES = 30        # 每个 Eps 跑 30 回合（快速平衡速度与统计意义）
EPSILON_LIST = [0.00,  0.01,  0.015,  0.02,  0.022,  0.025,  0.03,  0.035,  0.05] # 略过不敏感的点
    
PGD_ITER = 10          # 10步 PGD，兼顾强度与时间
VIDEO_FOLDER = "./humanoid_pgd_videos" # 视频保存路径
# ====================================================
